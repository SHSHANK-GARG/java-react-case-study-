...
public class PaymentServiceImpl implements PaymentService {
	...
	public void sendEmail(PaymentDetails payment) throws AddressException {
		final Email email = DefaultEmail.builder().from(new InternetAddress("gargshsh@gmail.com"))
				.replyTo(new InternetAddress("gargshsh@gmail.com"))
				.to(Lists.newArrayList(new InternetAddress("gargshsh@gmail.com")))
